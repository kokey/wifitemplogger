...
CFLAGS		= -Os -g -O2 -Wpointer-arith -Wundef -Werror -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals  -D__ets__ -DICACHE_FLASH -DSSID=\"$(SSID)\" -DSSID_PASS=\"$(SSID_PASS)\" -DSUBMITURL=\"$(SUBMITURL)\"
